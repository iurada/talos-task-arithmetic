...
from lora import LinLoRAImageEncoder
...
class _TaskVector(abc.ABC):
    ...
    def apply_to(self, pretrained_checkpoint, scaling_coef=1.0):
        ...
        pretrained_model.load_state_dict(new_state_dict, strict=False) #! strict=True
...
class LinLoRATaskVector(_TaskVector):
    """A task vector for linearized models."""

    def _load_checkpoint(self, checkpoint):
        """Load a checkpoint into a model."""
        return LinLoRAImageEncoder.load(checkpoint)
    ...
    def _cast_to_same_type(self, other):
        return other #nonlinear_to_linear(other)
