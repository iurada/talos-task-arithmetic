...
from datasets.imagenet import ImageNet, ImageNetLongTail
...
def get_dataset(dataset_name, preprocess, location, batch_size=128, num_workers=4, val_fraction=0.1, max_val_samples=5000, *args, **kwargs):
    ...
    dataset = dataset_class(
        preprocess, location=location, batch_size=batch_size, num_workers=num_workers, *args, **kwargs
    )
    return dataset