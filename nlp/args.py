...
def parse_arguments():
    ...
    parser.add_argument("--sparsity", type=float, default=0.9, help="Sparsity for prune finetune")
    parser.add_argument("--coeff", type=float, default=0.05, help="Sparsity coeff for prune finetune")
    parser.add_argument("--zero_t", type=float, default=1e-6, help="Sparsity zero_t for prune finetune")
    parser.add_argument("--epsilon", type=float, default=1e-4, help="Sparsity eps for prune finetune")
    parser.add_argument("--R", type=int, default=1, help="Sparsity R for prune finetune")
    parser.add_argument(
        "--warmup_length",
        type=int,
        default=500,
